...
"""Tests for cuTile matrix multiplication kernel."""
...
class TestCutileMatmul:
    """Test suite for cuTile matmul kernel."""
    ...
    def test_correctness_float32(self, kernel, is_compile_only, size):
        ...
        # cuTile uses tf32, so slightly looser tolerance
    ...
    def test_compile_sm100(self, kernel):
